...
from ai.cli import build_parser, build_system_prompt, _get_language_name
...
class TestBuildSystemPrompt:
    ...
    def test_with_glossary(self) -> None:
        prompt = build_system_prompt(
            "Chinese", glossary_block="## Glossary\n- API → 接口"
        )
    ...
    def test_with_custom_instructions(self) -> None:
        prompt = build_system_prompt(
            "Chinese", custom_prompt="Use formal tone."
        )
...
class TestBuildParser:
    ...
    def test_all_args(self) -> None:
        ...
        args = parser.parse_args([
            ...
            "--glossary-min-priority", "high",
            "--cli-api-fallback",
            "--max-batch-chars", "30000",
        ])
    ...
    def test_short_prompt_flag(self) -> None:
        parser = build_parser()
        args = parser.parse_args([
            "in.epub", "--output", "out.epub", "-p", "Keep it short"
        ])
