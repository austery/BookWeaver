...
## Artifact preservation reconciliation after PR #26 review

The historical output hash above remains unchanged as an observation of the original generated artifact. Later inspection found that the file at the original output path hashes to `6a8bbe9bfa0df3b358ecab899e38f87cf281155895a6749bd67cb867188db0b5`. ZIP comparison against `tmp/book-validation/stoic-joy-20260907/stoic-joy-bilingual.epub` found exactly one added entry, `META-INF/calibre_bookmarks.txt`, zero removed entries, zero changed original entries, and unchanged relative ordering of all original entries. This is consistent with Calibre adding reader bookmarks; the responsible process was not independently observed.

The temporary original still hashes to the historical `ff2cd06bb068554c164a07ffcf6687c4ed6be9c91af92e4301f3e4ada4b660c0`. An exact copy is now preserved at `output/stoic-joy-20260907/A Guide to the Good Life - bilingual pristine.epub`. The current reader-annotated file was not overwritten. The original generated bytes survive, but the original delivery path is not byte-immutable; earlier preservation claims should be read with this qualification. Book content changes were not found in this comparison.
